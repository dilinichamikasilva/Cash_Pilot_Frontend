...
const SettingsPage = () => {
  ...
  return (
    <DashboardLayout> {/* 2. Wrap everything in the layout */}
              ...
              <div className="flex flex-col md:flex-row items-center gap-8 bg-indigo-50/50 p-8 rounded-[24px] border border-indigo-100/50">
                <div className="relative group cursor-pointer" onClick={() => fileInputRef.current?.click()}>
                  <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-xl bg-white">
                    {formData.picture ? (
                      <img src={formData.picture} className="w-full h-full object-cover" alt="Profile" />
                    ) : (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      type="text" 
                      className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 ring-indigo-500/10 focus:border-indigo-500 focus:bg-white transition-all outline-none font-medium text-slate-700"
                      value={formData.name}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input type="email" disabled className="w-full pl-12 pr-4 py-4 bg-slate-100 border border-slate-200 rounded-2xl text-slate-400 cursor-not-allowed font-medium" value={formData.email} />
                  </div>
                </div>
